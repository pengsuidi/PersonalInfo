...
public class Food_Menu implements Parcelable {
    ...
    public Food_Menu(int food_id, int count, String food_image_addr, String food_name, String food_description, Float food_price, String food_type, Integer shop_id, byte[] food_image, String uri, String image_64) {
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeFloat(this.food_price);
