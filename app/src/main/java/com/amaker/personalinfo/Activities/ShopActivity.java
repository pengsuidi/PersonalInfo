...
public class ShopActivity extends AppCompatActivity implements View.OnClickListener {
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case Config.STATUS_OK://网络请求成功，但响应需要根据实际来操作
                    System.out.println("ShopActivity中从GetShopInfoByShopidServlet获得响应的时间:" + System.currentTimeMillis());
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String shopid=getIntent().getStringExtra(Config.REQUEST_PARAMETER_SHOP_ID);
        //使用shopid初始化
        System.out.println("ShopActivity:shopid:-------:" + shopid);
        Map<String, Object> param = new HashMap<>();
        param.put(Config.REQUEST_PARAMETER_SHOP_ID, String.valueOf(shopid));
        OkHttpUtil.post(Config.URL_GetShopInfoByShopidServlet, param, handler);
        System.out.println("ShopActivity中向GetShopInfoByShopidServlet发送请求的时间:" + System.currentTimeMillis());

        //把shopid写入bundler
        bundle = new Bundle();
        bundle.putString(Config.REQUEST_PARAMETER_SHOP_ID, String.valueOf(shopid));
    }
