...
public class ShoppingcarActivity extends AppCompatActivity {
    ...
    private ArrayList<String> food_id_list = new ArrayList<>();
            ...
            switch (msg.what) {
                case Config.STATUS_OK://网络请求成功，但响应需要根据实际来操作
                    ...
                    if (result.getCode() == Config.STATUS_SUCCESS) {
                        ...
                        System.out.println("该商店的食物个数:" + foodMenus.size());
                        FoodDatas.clear();
                        //获取总的食物链表
                        FoodDatas.addAll(foodMenus);
                        System.out.println("购买的数量:" + food_id_list.size());
                        ...
                        for (int j = 0; j < food_id_list.size(); j++) {
                            System.out.println("此次购买的食物ID:" + String.valueOf(food_id_list.get(j)));
                        }
                        ...
                        for (int i = 0; i < OrderedFoodList.size(); i++) {
                            sum += OrderedFoodList.get(i).getFood_price();
                        }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //获得OrderedFoodList
        System.out.println("购物车界面shoppingcar   shopid:" + getIntent().getStringExtra(Config.REQUEST_PARAMETER_SHOP_ID));
    ...
    private void init() {
        ...
        buy_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putStringArrayListExtra(Config.FOOD_ID_LIST, food_id_list);
